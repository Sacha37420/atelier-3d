...
from .views import (
    ...
    ReconstructionEstimateView, ReconstructionLaunchView, MeshImportLaunchView, JobListView, JobDetailView,
...
urlpatterns = [
    ...
    path('projects/<int:pk>/mesh-import/',           MeshImportLaunchView.as_view()),
